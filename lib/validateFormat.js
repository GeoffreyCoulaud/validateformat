...
class Num extends Format {
  constructor(options) {
    ...
    if (typeof options === 'object') {
      ...
      if (options.hasOwnProperty('forceInt')) {
        forceInt = options.forceInt;
      }
    }
  ...
  constructor(options) {
    ...
    this.match = function (obj) {
      ...
      if (this.size !== null) {
        ...
        if (this.min !== null && obj.length < this.min) {
          return false;
        }

        if (this.max !== null && obj.length > this.max) {
          return false;
        }
      }
